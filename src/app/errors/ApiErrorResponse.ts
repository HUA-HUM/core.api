export const ApiErrorCode = {
  ...
  nfcTagInviteeNotFound: 'NFC_TAG_INVITEE_NOT_FOUND',
  nfcTagMemberAlreadyLinked: 'NFC_TAG_MEMBER_ALREADY_LINKED',
  nfcTagOwnerRequired: 'NFC_TAG_OWNER_REQUIRED',
  nfcTagParentLinkExists: 'NFC_TAG_PARENT_LINK_EXISTS',
